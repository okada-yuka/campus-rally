...
public struct CreateTodoInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, name: String, exp: Int? = nil) {
    graphQLMap = ["id": id, "name": name, "exp": exp]
  }
...
public struct ModelTodoConditionInput: GraphQLMapConvertible {
  ...
  public init(name: ModelStringInput? = nil, exp: ModelIntInput? = nil, and: [ModelTodoConditionInput?]? = nil, or: [ModelTodoConditionInput?]? = nil, not: ModelTodoConditionInput? = nil) {
    graphQLMap = ["name": name, "exp": exp, "and": and, "or": or, "not": not]
  }
...
public struct UpdateTodoInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, name: String? = nil, exp: Int? = nil) {
    graphQLMap = ["id": id, "name": name, "exp": exp]
  }
...
public struct ModelTodoFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, name: ModelStringInput? = nil, exp: ModelIntInput? = nil, and: [ModelTodoFilterInput?]? = nil, or: [ModelTodoFilterInput?]? = nil, not: ModelTodoFilterInput? = nil) {
    graphQLMap = ["id": id, "name": name, "exp": exp, "and": and, "or": or, "not": not]
  }
...
public final class CreateTodoMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateTodo: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, name: String, exp: Int? = nil, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Todo", "id": id, "name": name, "exp": exp, "createdAt": createdAt, "updatedAt": updatedAt])
      }
