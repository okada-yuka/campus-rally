...
class MapKitViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //        以下ピン
        addAnnotation(latitude: 35.689830,  longitude: 139.697320, title: "場所１", subtitle: "サブタイトル")
        addAnnotation(latitude: 35.683082,  longitude: 139.701510, title: "場所2", subtitle: "サブタイトル")
